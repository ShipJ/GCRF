...
activity_1 = pd.DataFrame(pd.read_csv(path+'/CDR/static_metrics/Activity/activity_adm1.csv'))
activity_2 = pd.DataFrame(pd.read_csv(path+'/CDR/static_metrics/Activity/activity_adm2.csv'))
activity_3 = pd.DataFrame(pd.read_csv(path+'/CDR/static_metrics/Activity/activity_adm3.csv'))
activity_4 = pd.DataFrame(pd.read_csv(path+'/CDR/static_metrics/Activity/activity_adm4.csv'))
