...
introversion_1 = pd.DataFrame(pd.read_csv(path+'/CDR/static_metrics/Introversion/introversion_adm1.csv'))
introversion_2 = pd.DataFrame(pd.read_csv(path+'/CDR/static_metrics/Introversion/introversion_adm2.csv'))
introversion_3 = pd.DataFrame(pd.read_csv(path+'/CDR/static_metrics/Introversion/introversion_adm3.csv'))
introversion_4 = pd.DataFrame(pd.read_csv(path+'/CDR/static_metrics/Introversion/introversion_adm4.csv'))
