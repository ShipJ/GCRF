...
if __name__ == "__main__":
    ...
    # np.savetxt(path+'/CDR/static_metrics/Introversion/introversion_adm_1.csv', introversion_adm_1, delimiter=',')
    # np.savetxt(path+'/CDR/static_metrics/Introversion/introversion_adm_2.csv', introversion_adm_2, delimiter=',')
    # np.savetxt(path+'/CDR/static_metrics/Introversion/introversion_adm_3.csv', introversion_adm_3, delimiter=',')
    # np.savetxt(path+'/CDR/static_metrics/Introversion/introversion_adm_4.csv', introversion_adm_4, delimiter=',')
