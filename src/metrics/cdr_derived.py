...
if __name__ == '__main__':
    ...
    cdr_fundamentals = pd.DataFrame(pd.read_csv(PATH+'/processed/%s/cdr/metrics/cdr_fundamentals_bts_all.csv'
                                                % country))
    ...
    cdr_fundamentals.to_csv(PATH+'/processed/%s/cdr/metrics/cdr_derived_bts_all.csv' % country, index=None)
