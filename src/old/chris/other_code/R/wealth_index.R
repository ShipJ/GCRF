...
# e.g. from inside SN_2012-13_ContinuousDHS_07202016_1026_50936 folder
# hr_file <- 'snhr6dsv/SNHR6DFL.SPS'
# ge_path <- 'snge6afl'
# ge_file <- 'SNGE6AFL.shp'
# outfile <- wealth_index.csv
# zone <- 28 (the UTM zone)
